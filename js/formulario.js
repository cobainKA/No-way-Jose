(function(){
    ...
    var propFormulario = {
        ...
        elementos: document.formulario_registro.elements,
        error: null,
        textoError: null
    ...
    var metFormulario = {
        ...
        inicio : function() {
            ...
            for (var i = 0; i < propFormulario.elementos.length; i++) {
                ...
                if( propFormulario.elementos[i].type == 'text' || propFormulario.elementos[i].type == 'email' || propFormulario.elementos[i].type == 'password' ){
